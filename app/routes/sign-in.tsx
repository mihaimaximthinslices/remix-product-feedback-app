...
import { compareHash } from "~/utils.server";
...
export const action = async ({
  ...
  if (!user || !(await compareHash(password, user.password))) {
    return json(
      {
        errors: {
          other: "Email or password is not correct",
        },
      },
      { status: 400 }
    );
    ...
    <div className="flex h-full items-center justify-center">
      ...
      >
        <fieldset disabled={isSubmitting} className="flex flex-col gap-2">
          ...
          <hr className="border-gray2 mb-1 w-full mt-1" />
          <div className="flex flex-col items-center w-full gap-4">
            ...
            <div>
              <span>
                ...
                <a href="/sign-up" className="text-link1 hover:text-link1Hover">
                  Sign up
                </a>
              </span>
            </div>
